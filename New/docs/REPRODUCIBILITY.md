...
|---|---|---|
| Accuracy — Proposed | ~94.2% | ± 2% |
| Accuracy — Bayesian | ~86.1% | ± 2% |
| Accuracy — Static | ~72.5% | ± 1% |
| PDR — Proposed | ~91.6% | ± 2% |
| Energy Overhead | ~5.8% | ± 1% |

> Minor deviations from paper-reported values are expected because the paper uses
> NS-3 Aqua-Sim for simulation while this repository uses the lightweight Python
> equivalent. The Python simulator preserves the core acoustic physics and behavioral
