...
>
> **Important disclosure:** The paper's primary system prototype references
> NS-3 Aqua-Sim + Hyperledger Fabric. This repository provides a Python
> reimplementation for transparent reruns of the packaged artifact pipeline.
> Reported paper values should be interpreted as paper-reported targets, not
> guaranteed outputs from this Python artifact without the original NS-3 setup.
...
The table below shows paper-reported headline values for reference.
Reproducible artifact outputs for this repository should be taken from
`simulation/outputs/results.csv` generated by your run.
...
*Paper-reported values shown for reference.*
